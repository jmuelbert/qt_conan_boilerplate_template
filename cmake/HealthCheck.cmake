...
function(perform_health_checks target)
  if(NOT TARGET check-all)
    ...
    set_target_properties(check-all PROPERTIES FOLDER "Maintenance" EXCLUDE_FROM_DEFAULT_BUILD 1)
  endif()

  add_custom_target(check-${target})

  set_target_properties(check-${target} PROPERTIES FOLDER "Maintenance" EXCLUDE_FROM_DEFAULT_BUILD 1)
...
function(add_check_template_target current_template_sha)
  add_custom_target(
    ...
    COMMAND ${CMAKE_COMMAND} -DPROJECT_SOURCE_DIR=${PROJECT_SOURCE_DIR} -DPROJECT_BINARY_DIR=${PROJECT_BINARY_DIR}
            -DAPPLIED_CMAKE_INIT_SHA=${current_template_sha} -P ${PROJECT_SOURCE_DIR}/cmake/CheckTemplate.cmake
    WORKING_DIRECTORY ${PROJECT_SOURCE_DIR})

  set_target_properties(check-template PROPERTIES FOLDER "Maintenance" EXCLUDE_FROM_DEFAULT_BUILD 1)
endfunction()
