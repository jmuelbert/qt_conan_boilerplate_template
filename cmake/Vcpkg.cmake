...
macro(run_vcpkg)
    ...
    if(EXISTS "${_vcpkg_args_VCPKG_DIR}" AND EXISTS "${_vcpkg_args_VCPKG_DIR}/vcpkg${CMAKE_EXECUTABLE_SUFFIX}")
        ...
        if(${_vcpkg_args_ENABLE_VCPKG_UPDATE})
            ...
            if(NOT "${_vcpkg_args_VCPKG_REV}" STREQUAL "")
                ...
                if("${GIT_STATUS}" STREQUAL "HEAD")
                    ...
                    execute_process(
                        COMMAND "${GIT_EXECUTABLE}" "switch" "-" WORKING_DIRECTORY "${_vcpkg_args_VCPKG_DIR}"
                    )
                endif()
            endif()
        ...
        if(NOT EXISTS "${_vcpkg_args_VCPKG_DIR}")
            ...
            execute_process(
                COMMAND "${GIT_EXECUTABLE}" "clone" "${_vcpkg_args_VCPKG_URL}"
    ...
    if(NOT "${_vcpkg_args_VCPKG_REV}" STREQUAL "")
        execute_process(
            COMMAND "${GIT_EXECUTABLE}" "checkout" "${_vcpkg_args_VCPKG_REV}"
